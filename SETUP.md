...
WEBEX_BOT_EMAIL=your_webex_email@example.com
WEBEX_ROOM_ID=
```
- **How it Works**: When a meeting ends, your bot sends the full transcript directly to your personal 1:1 Webex chat.
- **AI Summary**: You can forward or paste the transcript directly into your 1:1 chat with My Agent (`your_agent@webex.bot`) for instant executive summaries and action items.

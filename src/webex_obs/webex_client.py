...
class WebexClient:
    def __init__(self, token: str, my_agent_email: str = "your_webex_email@example.com", room_id: str = ""):
        self.token = token
                ...
                if res.status_code == 404:
                    if self.room_id:
                        ...
                        logger.error(
                            ...
                            "WEBEX_BOT_EMAIL in .env is set to your personal Cisco email (e.g. your_webex_email@example.com)."
                        )
                return False
